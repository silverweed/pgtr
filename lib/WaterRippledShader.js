...
THREE.ShaderLib[ 'waterRippled' ] = {
	...
	vertexShader: [
		...
		'	dist = length(worldPosition - playerPos);',
		'	float delta = 0.0;',
		'	if (dist > 8.0) delta = 40.0 * sin(3.0 * time - dist) / dist;',
	...
	fragmentShader: [
		...
		'	gl_FragColor = vec4( outgoingLight, 3.0 * alpha / dist);',
...
THREE.WaterRippled.prototype.constructor = THREE.Water;
